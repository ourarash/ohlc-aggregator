 ...
 * @param {Number} intervalInSeconds
 */
function aggregate(array, intervalRatio, intervalInSeconds) {
  let result = [];
  ...
  // console.log(
  //   "array[rightIndex].time:",
  //   moment(array[rightIndex].time).format("M/D/YYYY H:mm")
  // );
  ...
  if (firstLeftIndex > 0 && firstLeftIndex < array.length) {
    // console.log(
    //   "array[firstLeftIndex].time:",
    //   moment(array[firstLeftIndex].time).format("M/D/YYYY H:mm")
    // );
  }
